<?php
	...
	$listereservation=$reservationC->affichereservationsbyID(); 
?>
  ...
  $('.tbl-header').css({'padding-right':scrollWidth});
    ...
    <body class="sb-nav-fixed">
	   ...
	   <section>
		...
		<thead>
			<tr>
				<th><a href="afficherReservation.php" style='background:#bd2536;color:#ffffff;font-size:15px;padding:8px 12px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;text-decoration:none;'>id_table</a></th>
				<th>Nom client</th>
				<th>Date</th>
                <th>nombre</th>
