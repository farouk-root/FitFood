<?php
	...
	$listereservation=$reservationC->affichereservationsbydate(); 
?>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                ...
                <div >
                <center><a href="AjouterReservation.php" class="button"><img src="assets/img/add.png" width="50" height="50" > Ajouter Table</a> </center>
</div >
                <div >
	   <section>
		...
		<thead>
			<tr>
            <th><a href="afficherReservationbyID.php" style='color:#ffffff;font-size:15px;padding:8px 12px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;text-decoration:none;'>Idclient</a></th>
				<th>Nom client</th>
				<th><a href="afficherReservation.php" style='background:#bd2536;color:#ffffff;font-size:15px;padding:8px 12px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;text-decoration:none;'>Date</a></th>
                <th>nombre</th>
		...
		<td>
		 			<a href="supprimerReservation.php?id_table=<?php echo $reservationC['id_table']; ?>"><img src="assets/img/delete.png" width="50" height="50" ></a>
				</td>
		 	</tr>
		 	<?php
		 		}
