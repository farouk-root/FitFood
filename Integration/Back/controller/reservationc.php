...
class reservationc{
	...
	function afficherreservation(){
		...
		function affichereservationsbydate(){
			$sql="SELECT * FROM reservation ORDER BY datereservation";
			$db = config::getConnexion();
			try{
				$liste = $db->query($sql);
				return $liste;
		...
		function affichereservationsbyID(){
			$sql="SELECT * FROM reservation ORDER BY id_table";
			$db = config::getConnexion();
			try{
				$liste = $db->query($sql);
				return $liste;
		...
		function rechercherreclamation($nom)
    {
        $requete = "select * from reservation where name like '%$nom%'";
