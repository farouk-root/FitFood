<?php
    ...
    { 
        $listereservation=$reservationC->rechercherreclamation($_GET['recherche']);
}else
$listereservation=$reservationC->afficherreservation();
?>
	   ...
	   <section>
		...
		<thead>
			<tr>
				...
				<th>Nom client</th>
				<th><a href="afficherReservationbydate.php" style='color:#ffffff;font-size:15px;padding:8px 12px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;text-decoration:none;'>Date</a></th>
                <th>nombre</th>
