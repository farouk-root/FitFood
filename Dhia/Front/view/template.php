    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="navbar-brand m-auto" href="#">
                ...
                <span class="brand-txt">Fit Food</span>
            </a>
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <div class="">
            ...
            <div class="row mb-5">
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="number" id="id_table" name="id_table" class="form-control form-control-lg custom-form-control" placeholder="id_table" >
                </div>
                
                </div>
            <div class="row mb-5">
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="text" id="name" name="name" class="form-control form-control-lg custom-form-control" placeholder="Type Name...">
                </div>
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="date" id="datereservation" name="datereservation" class="form-control form-control-lg custom-form-control" placeholder="12/12/12">
                </div>
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="number" id="nombre" name="nombre" class="form-control form-control-lg custom-form-control" placeholder="NUMBER OF GUESTS" max="20" min="0">
                </div>
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="text" id="num_tel"  name="num_tel" class="form-control form-control-lg custom-form-control" placeholder="Phone">
                </div>
                
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="number" id="id_client" name="id_client" class="form-control form-control-lg custom-form-control" placeholder="ID user " >
                </div>
