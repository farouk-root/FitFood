<?php
    ...
    if (isset($_POST["id"])) {
        ...
        if (isset($_POST["body"])) {
            $resolution_info["body"] = $_POST["body"];
        }
        ...
        if (isset($_POST["body"])) {
            ResolutionC::modifyResolution($resolution);
        }
            ...
            <form method="POST">
                ...
                <table border="0" align="center" width=90% rules="row">
                    <tr>
                        ...
                        <td>
                            <textarea rows="6" style="font-size:16px;resize: none;" name="body" id="body"> <?php echo $resolution_info["body"]; ?> </textarea>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
