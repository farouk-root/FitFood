    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div >
                <center><a  class="button"><img src="assets/img/add.png" width="50" height="50" > Ajouter Table</a> </center>
</div >
<div >
	   <section>
		<center><h1>Liste des places parking </h1></center>
		...
		<thead>
			...
			<tbody>
			<?php
			foreach($listepark as $parkC){
			?>
			<tr>
		 		<td><?php echo $parkC['placepark']; ?></td>
				<td><?php echo $parkC['Bloc']; ?></td>
		 		<td><?php echo $parkC['nb_places']; ?></td>

				<td>
		 			
					<input type="image" src="assets/img/update (1).png" width="50" height="50"> 
	 				
		 			
		 		</td>
		<td>
		 			<img src="assets/img/delete.png" width="50" height="50" >
				</td>
		 	</tr>
		 	<?php
		 		}
